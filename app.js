...
function FAQSection() {
  ...
  const allFAQs = [
    { cat: "About Nevisan", q: "Where is Nevisan tea from?", a: "Nevisan teas are single origin — sourced exclusively from one PGS-India certified organic garden in Golaghat, upper Assam. No blending with leaves from other regions." },
    { cat: "About Nevisan", q: "What makes Nevisan different from supermarket tea?", a: "Most supermarket teas use CTC (Cut, Tear, Curl) which reduces whole leaves to granules for fast brewing. Nevisan uses 100% whole leaf that can be steeped 2–3 times, retaining more L-theanine, EGCG antioxidants and flavour complexity." },
    { cat: "About Nevisan", q: "Is Nevisan tea organic and chemical-free?", a: "Yes. Every batch is PGS-India organic certified and grown without pesticides or chemicals. From soil to seal, completely chemical-free." },
    { cat: "About Nevisan", q: "What certifications does Nevisan hold?", a: "Nevisan holds PGS-India (Participatory Guarantee System) organic certification — India's most rigorous grassroots organic verification system, run by farmers for farmers." },
    { cat: "About Nevisan", q: "Are your teas whole leaf or tea bags?", a: "100% whole leaf — never fannings or dust. Whole leaf releases polyphenols more slowly, making a smoother, more complex cup that can be re-steeped." },
    { cat: "About Nevisan", q: "How many flavours does Nevisan offer?", a: "Currently 9 flavours: Lemongrass Green, Blue Flower Green, Rum Green, Spearmint Green, Tulsi Green, Chamomile Green, Whiskey Green, GABA Oolong, and Organic Green." },
    { cat: "About Nevisan", q: "Who started Nevisan and why?", a: "Nevisan was founded to bring single-origin, whole-leaf Assam tea to health-conscious Indian consumers — with full transparency about origin, certifications and ingredients." },
    { cat: "About Nevisan", q: "Is Nevisan available offline?", a: "Currently available online via Amazon India, Flipkart and direct WhatsApp orders. We are expanding to select offline retail — follow us on Instagram for updates." },
    { cat: "About Nevisan", q: "What does the name Nevisan mean?", a: "Nevisan is inspired by the natural landscape of the Assam tea gardens — evoking the idea of pure nature, untouched soil and honest craft." },
    { cat: "About Nevisan", q: "Can I visit the Nevisan garden?", a: "The garden is in Golaghat, Assam. While we do not yet have a formal visitor programme, reach out on WhatsApp — we love connecting people with our source." },
    { cat: "Buying Guide", q: "Which tea is best for a beginner?", a: "Lemongrass Green Tea is the most approachable — light, citrusy and hard to brew wrong. Chamomile Green is great for floral preferences. Both are forgiving and enjoyable without sweetener." },
    { cat: "Buying Guide", q: "Which tea is best for stress and anxiety?", a: "GABA Oolong — it converts glutamate to GABA in the leaves during processing, naturally calming the nervous system without sedation. Many customers drink it during work hours." },
    { cat: "Buying Guide", q: "Which tea is best for sleep?", a: "Chamomile Green Tea — chamomile contains apigenin which binds to GABA receptors and promotes relaxation. Brew 30–45 minutes before bed." },
    { cat: "Buying Guide", q: "Which tea is best for weight management?", a: "Organic Green Tea or GABA Oolong — both are high in EGCG catechins which support metabolism. Drink 2–3 cups daily, 30 minutes before meals for best results." },
    { cat: "Buying Guide", q: "Is Nevisan tea a good gift?", a: "Yes — unusual, premium and practical. Popular combinations: Rum + Whiskey for spirit lovers, Spearmint + Chamomile for wellness-focused women, GABA + Chamomile for stress or sleep. Contact us on WhatsApp for custom gift packaging." },
    { cat: "Buying Guide", q: "What is the price per pack?", a: "All Nevisan teas are ₹499 for a 50g pack. When re-steeped, each pack makes 50–75 cups — working out to ₹6–10 per cup." },
    { cat: "Buying Guide", q: "Can I buy a sample or trial pack?", a: "We offer curated assorted packs on request via WhatsApp. Message us at +91 98642 45687 and we can suggest the best 2–3 teas for you to start with." },
    { cat: "Buying Guide", q: "Do Rum Green Tea or Whiskey Green Tea contain alcohol?", a: "No — both are completely alcohol-free. The rum and whiskey character comes from natural botanicals and a cold-infusion technique. Safe for non-drinkers, people in recovery, and children." },
    { cat: "Buying Guide", q: "Which tea is best for PCOS?", a: "Spearmint Green Tea — a 2010 clinical trial found two cups daily for 30 days significantly reduced free testosterone in women with PCOS. Consistent drinking over 4–6 weeks shows the best results." },
    { cat: "Buying Guide", q: "I want something unique — what should I try?", a: "Blue Flower Green Tea — the butterfly pea flower turns the brew a vivid cobalt blue, and adding lemon turns it purple. Both visually stunning and antioxidant-rich. Perfect for someone who enjoys the theatre of tea." },
    { cat: "Shipping & Orders", q: "Do you deliver across India?", a: "Yes! We deliver pan-India via Amazon and Flipkart. You can also order directly on WhatsApp at +91 98642 45687 for personal assistance." },
    { cat: "Shipping & Orders", q: "How long does delivery take?", a: "Amazon and Flipkart orders typically arrive in 3–5 business days. WhatsApp orders are dispatched within 24 hours of confirmation." },
    { cat: "Shipping & Orders", q: "What is your return or replacement policy?", a: "As tea is consumable, all sales are final. However, if you receive a damaged, near-expiry or incorrect product, contact us on WhatsApp within 48 hours and we will replace it immediately — no questions asked." },
    { cat: "Shipping & Orders", q: "Do you ship internationally?", a: "Not currently. We are exploring international shipping options. Message us on WhatsApp at +91 98642 45687 if you are outside India — we can check if your location is feasible." },
    { cat: "Shipping & Orders", q: "Can I change or cancel my order?", a: "WhatsApp orders can be changed or cancelled before dispatch. For Amazon/Flipkart orders, use the platform's cancellation window. Once dispatched, cancellation is not possible." },
    { cat: "Shipping & Orders", q: "Do you offer bulk or wholesale orders?", a: "Yes! For hotels, cafes, offices or bulk gifting, reach out on WhatsApp at +91 98642 45687. Minimum order is 20–30 packs. Custom assorted gift packs can also be arranged." },
    { cat: "Lemongrass Green", q: "What does Lemongrass Green Tea taste like?", a: "Fresh, citrusy and slightly grassy. The lemongrass gives a bright lift that makes it feel like a cleanse in a cup. Light in the mouth with a clean, lingering finish." },
    { cat: "Lemongrass Green", q: "What are the benefits of Lemongrass Green Tea?", a: "Aids digestion, reduces bloating, supports immunity, and has mild antimicrobial properties. The green tea base adds EGCG antioxidants and L-theanine for calm focus." },
    { cat: "Lemongrass Green", q: "How do I brew Lemongrass Green Tea?", a: "Use water at 80–85°C (not boiling). Steep 1 tsp per cup for 2.5–3 minutes. Can be re-steeped 2–3 times. Also excellent cold-brewed overnight in the fridge." },
    { cat: "Lemongrass Green", q: "Can I drink Lemongrass Green Tea every day?", a: "Yes — daily consumption is safe and beneficial. 2–3 cups per day is the optimal range for reaping antioxidant and digestive benefits." },
    { cat: "Lemongrass Green", q: "Can I have Lemongrass Green Tea in pregnancy?", a: "Lemongrass is generally advised in moderation during pregnancy. Consult your doctor before regular use if pregnant or breastfeeding." },
    { cat: "Lemongrass Green", q: "Is Lemongrass Green Tea good after meals?", a: "Excellent — the digestive and carminative properties of lemongrass make it one of the best post-meal teas. Drink 30 minutes after eating." },
    { cat: "Lemongrass Green", q: "Does Lemongrass Green Tea contain caffeine?", a: "Yes — the green tea base contains approximately 15–30mg of caffeine per cup (less than coffee). Suitable for most of the day, but avoid after 6pm if caffeine-sensitive." },
    { cat: "Blue Flower Green", q: "What does Blue Flower Green Tea look like when brewed?", a: "It brews a vivid cobalt or indigo blue. Add lemon or any acidic ingredient and it turns purple or lavender — a dramatic colour change due to the anthocyanins in butterfly pea flower." },
    { cat: "Blue Flower Green", q: "What are the benefits of Blue Flower Green Tea?", a: "Rich in anthocyanins (some of the most potent plant antioxidants), supports eye health, skin glow, and cognitive function. The green tea base adds L-theanine and EGCG." },
    { cat: "Blue Flower Green", q: "Does Blue Flower Green Tea have any taste?", a: "Mild and slightly earthy with a subtle floral note. Much of the appeal is visual — it pairs beautifully with honey and lemon which also transforms the colour." },
    { cat: "Blue Flower Green", q: "How many times can I re-steep Blue Flower Green Tea?", a: "2–3 times. Each re-steep will be lighter in colour and flavour. The colour change with lemon still works beautifully on the second steep." },
    { cat: "Blue Flower Green", q: "Is Blue Flower Green Tea safe to drink daily?", a: "Yes — butterfly pea flower has been consumed in Southeast Asia and India for centuries with no known side effects at normal consumption. 1–2 cups daily is recommended." },
    { cat: "Blue Flower Green", q: "Can Blue Flower Green Tea improve skin?", a: "The anthocyanins are potent antioxidants that help neutralise free radicals linked to premature skin ageing. Consistent consumption over weeks is where skin benefits become visible." },
    { cat: "Rum Green", q: "Does Rum Green Tea contain alcohol?", a: "No — completely alcohol-free. The rum character comes from natural botanicals. Safe for non-drinkers, people in recovery, and children." },
    { cat: "Rum Green", q: "What does Rum Green Tea taste like?", a: "Warm, slightly sweet, with a caramel-molasses undertone that genuinely resembles the aroma of aged rum — but in a light, clean cup of green tea." },
    { cat: "Rum Green", q: "Who is Rum Green Tea best for?", a: "Anyone who loves the idea of a sophisticated, warming drink without alcohol. Particularly popular as an evening cup or a gift for spirit enthusiasts." },
    { cat: "Rum Green", q: "How do I brew Rum Green Tea?", a: "80–85°C water, 1 tsp per cup, steep 2.5–3 minutes. For a more intense rum character, steep slightly longer or use slightly more leaf." },
    { cat: "Rum Green", q: "Can Rum Green Tea be served cold?", a: "Excellent cold-brewed — the caramel notes come through beautifully chilled. Steep in cold water in the fridge for 6–8 hours." },
    { cat: "Rum Green", q: "Is Rum Green Tea good for gifting?", a: "One of our most gifted teas — the name and concept delight people who receive it. Pairs perfectly with Whiskey Green Tea as a gift set." },
    { cat: "Spearmint Green", q: "What does Spearmint Green Tea taste like?", a: "Cool, fresh mint with a milder, sweeter profile than peppermint. Refreshing without being sharp — more subtle and elegant." },
    { cat: "Spearmint Green", q: "Is Spearmint Green Tea good for PCOS?", a: "Yes — a 2010 clinical trial in Phytotherapy Research showed two cups daily for 30 days significantly reduced free testosterone in women with PCOS. Results are most visible with consistent use over 4–6 weeks." },
    { cat: "Spearmint Green", q: "Can I drink Spearmint Green Tea during my period?", a: "Yes — it helps reduce cramps and bloating. Some women find it particularly soothing during the first few days of their cycle." },
    { cat: "Spearmint Green", q: "Does Spearmint Green Tea have hormonal effects?", a: "Yes — spearmint has anti-androgenic properties. This is beneficial for women with high androgens (as in PCOS) but men consuming 3+ cups daily may want to moderate intake." },
    { cat: "Spearmint Green", q: "Is Spearmint Green Tea good for digestion?", a: "Yes — mint has long been used for IBS, bloating and digestive discomfort. The combination with green tea enhances these gut-calming effects." },
    { cat: "Spearmint Green", q: "Can I drink Spearmint Green Tea cold?", a: "Yes — one of the best teas for cold brewing. Brew in cold water for 6–8 hours. Serve over ice with a squeeze of lemon for a refreshing summer drink." },
    { cat: "Spearmint Green", q: "How long before seeing PCOS benefits from Spearmint tea?", a: "Hormonal changes take time. Most women report improvement in symptoms — reduced facial hair, better cycle regularity — after 6–12 weeks of consistent daily use." },
    { cat: "Spearmint Green", q: "Does Spearmint Green Tea help with acne?", a: "Yes — by reducing excess androgens (a common cause of hormonal acne), spearmint can help reduce breakouts over time, particularly in women with PCOS or hormonal imbalances." },
    { cat: "Tulsi Green", q: "What is Tulsi Green Tea good for?", a: "Tulsi (Holy Basil) is an adaptogen — it helps the body respond to stress. Combined with green tea, it supports immunity, reduces cortisol, and promotes mental clarity." },
    { cat: "Tulsi Green", q: "What does Tulsi Green Tea taste like?", a: "Earthy and aromatic with a slightly peppery, clove-like warmth. Deeply satisfying — feels medicinal without being unpleasant." },
    { cat: "Tulsi Green", q: "Is Tulsi Green Tea safe to drink daily?", a: "Yes — tulsi has been consumed in India for thousands of years as a daily tonic. 2 cups daily is a traditional and effective dose." },
    { cat: "Tulsi Green", q: "Can Tulsi Green Tea help with immunity?", a: "Yes — tulsi has antimicrobial, antiviral and anti-inflammatory properties. Regular use supports immune resilience, especially during seasonal changes." },
    { cat: "Tulsi Green", q: "Can I have Tulsi Green Tea in pregnancy?", a: "Tulsi in large amounts is traditionally advised to be avoided during pregnancy. Consult your doctor before regular use if pregnant." },
    { cat: "Tulsi Green", q: "Is Tulsi Green Tea good for cold and cough?", a: "Excellent — tulsi has been used in Ayurveda for respiratory health for centuries. Drinking it hot with honey during a cold is a traditional and effective remedy." },
    { cat: "Chamomile Green", q: "What does Chamomile Green Tea taste like?", a: "Delicately floral with a light honey-like sweetness. Gentle, calming and soothing — one of the easiest teas to enjoy without any sweetener." },
    { cat: "Chamomile Green", q: "Does Chamomile Green Tea help with sleep?", a: "Yes — chamomile contains apigenin, a flavonoid that binds to GABA receptors in the brain, promoting relaxation and sleep onset. Drink 30–45 minutes before bed." },
    { cat: "Chamomile Green", q: "How do I brew Chamomile Green Tea?", a: "Use water at 75–80°C (cooler than most green teas to preserve the delicate floral notes). Steep 2–3 minutes. Can be re-steeped once." },
    { cat: "Chamomile Green", q: "Is Chamomile Green Tea caffeine-free?", a: "Not entirely — the green tea base contains low caffeine (~15–25mg per cup). Much less than coffee, but not zero. For a completely caffeine-free option, pure chamomile infusion is better." },
    { cat: "Chamomile Green", q: "Is Chamomile Green Tea good for anxiety?", a: "Yes — chamomile has mild anxiolytic effects. For more pronounced anti-anxiety support, try it alongside GABA Oolong during the day." },
    { cat: "Chamomile Green", q: "Can children drink Chamomile Green Tea?", a: "Chamomile is generally considered safe for children in small amounts. However, the green tea contains caffeine, so we recommend limiting to 1 small cup per day for children over 5, and avoiding for younger children." },
    { cat: "Whiskey Green", q: "Does Whiskey Green Tea contain alcohol?", a: "No — completely alcohol-free. The whiskey character comes from natural botanicals that mimic the aroma of aged Scotch — smoky, woody, slightly sweet." },
    { cat: "Whiskey Green", q: "What does Whiskey Green Tea taste like?", a: "Warm and complex — with subtle smoky, woody notes that genuinely evoke aged whiskey. Light on the palate but full in aroma." },
    { cat: "Whiskey Green", q: "Who is Whiskey Green Tea best suited for?", a: "People who love the ritual and complexity of whiskey but want something non-alcoholic. Also great for gifting to people who don't think they like tea." },
    { cat: "Whiskey Green", q: "How do I brew Whiskey Green Tea?", a: "80–85°C water, 1 tsp per cup, steep 2.5–3 minutes. Drink neat without milk — milk will completely mask the whiskey complexity." },
    { cat: "Whiskey Green", q: "Can Whiskey Green Tea be enjoyed in the evening?", a: "Yes — it is designed as an evening tea. The ritual resembles pouring a dram. Low in caffeine compared to coffee, making it suitable for most people in the evening." },
    { cat: "GABA Oolong", q: "What is GABA Oolong?", a: "GABA Oolong is processed under nitrogen-rich anaerobic conditions, converting glutamate to GABA (gamma-aminobutyric acid) in the tea leaves themselves — the calming neurotransmitter. The result is tea with measurably higher GABA content." },
    { cat: "GABA Oolong", q: "What are the benefits of GABA Oolong?", a: "Reduces anxiety, promotes calm focus without sedation, supports cardiovascular health, and helps regulate blood pressure. The high GABA content has documented cognitive and stress-reduction benefits." },
    { cat: "GABA Oolong", q: "What does GABA Oolong taste like?", a: "Complex — earthy, slightly fruity and more rounded than green tea. The processing gives it a depth not found in typical green teas. Often described as the most sophisticated of the Nevisan range." },
    { cat: "GABA Oolong", q: "How do I brew GABA Oolong?", a: "85–90°C water, 1 tsp per cup, steep 3–4 minutes. This is our only oolong — it benefits from slightly hotter water than green teas. Can be re-steeped 2–3 times." },
    { cat: "GABA Oolong", q: "Can I drink GABA Oolong if I have anxiety?", a: "Yes — it is specifically recommended for anxiety and stress management. Unlike some calming supplements, it provides calm clarity rather than drowsiness, making it ideal for daytime use." },
    { cat: "GABA Oolong", q: "How is GABA Oolong different from other teas?", a: "It is our only oolong — partially oxidised, more complex than green tea, and specially processed to maximise GABA content. It is our most functionally targeted tea." },
    { cat: "GABA Oolong", q: "How long before GABA Oolong reduces anxiety?", a: "Many people notice calming effects within 30–60 minutes of drinking a cup. For cumulative benefits on baseline anxiety, consistent daily use over 2–4 weeks shows the most change." },
    { cat: "Organic Green", q: "What is Organic Green Tea?", a: "Our purest offering — single-origin Assam green tea with nothing added. Just the whole leaf, organic-certified, with its natural grassy, umami-rich flavour." },
    { cat: "Organic Green", q: "What does Organic Green Tea taste like?", a: "Clean, grassy and slightly vegetal with a smooth finish. Assam green tea is bolder and more full-bodied than Darjeeling or Chinese greens." },
    { cat: "Organic Green", q: "What are the health benefits of Organic Green Tea?", a: "High in EGCG catechins (antioxidants), L-theanine (calm focus), and polyphenols. Supports metabolism, brain function, heart health and longevity with regular consumption." },
    { cat: "Organic Green", q: "How do I brew Organic Green Tea?", a: "80–85°C water, 1 tsp per cup, steep 2–3 minutes. Never use boiling water — it makes green tea bitter and destroys L-theanine." },
    { cat: "Organic Green", q: "Can I drink Organic Green Tea every day?", a: "Yes — daily consumption at 2–3 cups is considered optimal. Green tea is one of the most studied healthy beverages in the world." },
    { cat: "Health & Wellness", q: "Can I drink green tea on an empty stomach?", a: "Best to avoid it. Tannins in green tea can cause nausea or stomach irritation on a completely empty stomach. Drink 30–60 minutes after a light meal." },
    { cat: "Health & Wellness", q: "Can I add milk or sugar to Nevisan teas?", a: "Milk is not recommended — it binds to catechins and reduces antioxidant absorption. Honey is the best sweetener (add after brewing). Lemon is excellent, especially in Blue Flower tea." },
    { cat: "Health & Wellness", q: "How much caffeine is in Nevisan teas?", a: "Green teas: 15–30mg per cup. GABA Oolong: 20–35mg per cup. For comparison, coffee has 80–120mg. Chamomile Green has the least caffeine of our range." },
    { cat: "Health & Wellness", q: "Are Nevisan teas safe during pregnancy?", a: "Green tea in moderation (1–2 cups/day) is generally considered safe during pregnancy. However, Tulsi and Spearmint should be consumed with caution. Always consult your doctor during pregnancy." },
    { cat: "Health & Wellness", q: "Can Nevisan teas help with weight loss?", a: "Green tea (especially EGCG-rich varieties like Organic Green and GABA Oolong) has clinical evidence supporting modest metabolic benefits. Combined with diet and exercise, 2–3 cups daily can support fat oxidation." },
    { cat: "Health & Wellness", q: "Is green tea good for skin?", a: "Yes — EGCG catechins have anti-inflammatory and antioxidant properties that support skin health from within. Blue Flower Green Tea's anthocyanins are particularly potent for skin." },
    { cat: "Health & Wellness", q: "Can Nevisan teas interfere with medications?", a: "Green tea can interact with blood thinners (warfarin) and some stimulants. If you are on medication, consult your doctor before consuming large amounts of green tea." },
    { cat: "Health & Wellness", q: "Is it okay to drink green tea at night?", a: "For caffeine-sensitive individuals, avoid green tea after 5–6pm. Chamomile Green Tea is the best evening option — it has the least caffeine and actively promotes sleep." },
    { cat: "Health & Wellness", q: "Can men drink Spearmint Green Tea?", a: "Yes, but in moderation. Spearmint has anti-androgenic effects that are beneficial for women with PCOS. Men consuming 3+ cups daily over extended periods may want to moderate — 1 cup occasionally is completely fine." },
    { cat: "Health & Wellness", q: "Is Nevisan tea good for diabetics?", a: "Green tea has evidence supporting blood sugar regulation and insulin sensitivity. However, avoid adding sugar or honey if managing diabetes. Consult your doctor for guidance on quantity." },
    { cat: "Health & Wellness", q: "Can children drink Nevisan teas?", a: "Chamomile Green is the most suitable for children (caffeine is present but low). We recommend avoiding other varieties for children under 10. Always in small quantities." },
    { cat: "Health & Wellness", q: "How soon will I feel benefits from drinking Nevisan teas?", a: "Acute effects (calmness from GABA Oolong, digestion from Lemongrass) can be felt within 30–60 minutes. Cumulative benefits (hormonal balance, metabolism, skin) develop over 4–8 weeks of consistent use." },
    { cat: "Brewing & Storage", q: "What temperature should I brew green tea at?", a: "80–85°C for most green teas. Chamomile Green: 75–80°C. GABA Oolong: 85–90°C. Never use boiling water — it makes green tea bitter and destroys L-theanine. Boil then wait 3–4 minutes before pouring." },
    { cat: "Brewing & Storage", q: "How long should I steep Nevisan teas?", a: "2.5–3 minutes for most green teas. 2–3 minutes for Chamomile (more delicate). 3–4 minutes for GABA Oolong. Over-steeping causes bitterness — start short and adjust to taste." },
    { cat: "Brewing & Storage", q: "Can I re-steep Nevisan teas?", a: "Yes — whole leaf allows 2–3 steepings. The second steep is often softer and sweeter. Add 30–60 seconds to each subsequent steep." },
    { cat: "Brewing & Storage", q: "How should I store Nevisan tea?", a: "Cool, dry place away from sunlight, heat and strong odours. Tea absorbs smells — keep away from spices and coffee. An airtight container is ideal. Consume within 6 months of opening for best flavour." },
    { cat: "Brewing & Storage", q: "What is the shelf life of Nevisan teas?", a: "24 months from the date of manufacture when stored correctly. Check the batch date on your pack." },
    { cat: "Brewing & Storage", q: "Can I cold brew Nevisan teas?", a: "Yes — most Nevisan teas cold brew beautifully. Add 1.5–2 tsp per 300ml of cold water and refrigerate for 6–8 hours. Strain and serve over ice. Lemongrass, Spearmint and Blue Flower are exceptional cold-brewed." },
    { cat: "Brewing & Storage", q: "Should I use tap or filtered water?", a: "Filtered or bottled water gives the cleanest flavour. Tap water with heavy chlorination can mask the subtle notes in premium whole-leaf tea." },
    { cat: "Brewing & Storage", q: "Can I add honey to Nevisan teas?", a: "Yes — honey is the ideal sweetener. Add after brewing (not during) to preserve the enzymes and flavour of the honey. Raw honey pairs especially well with Chamomile and Tulsi." },
    { cat: "Brewing & Storage", q: "How much leaf should I use per cup?", a: "1 level teaspoon (approximately 2–2.5g) per 200–250ml of water. Adjust to taste — more leaf gives a stronger, more complex cup." },
    { cat: "Brewing & Storage", q: "Can I use a tea infuser or strainer?", a: "Yes — a wide-mesh infuser or a simple strainer works well. Whole leaves need room to expand as they steep, so avoid tight capsule infusers." },
    { cat: "Gifting", q: "Is Nevisan tea good for corporate gifting?", a: "Excellent — premium, unique and wellness-focused. We offer custom assorted packs for corporate gifting with minimum 20 packs. WhatsApp us at +91 98642 45687 for quotes and lead times." },
    { cat: "Gifting", q: "What are the best Nevisan teas to gift someone?", a: "For wellness: Spearmint + Chamomile. For a curious tea drinker: Blue Flower + GABA Oolong. For someone who loves spirits: Rum Green + Whiskey Green. For a beginner: Lemongrass + Organic Green." },
    { cat: "Gifting", q: "Can I get custom packaging for gifting?", a: "Yes — we can arrange custom gift packaging and assorted packs. Message us on WhatsApp at +91 98642 45687 with your requirements and budget." },
    { cat: "Gifting", q: "Do you offer gift wrapping?", a: "Yes, on request for WhatsApp orders. Mention it when placing your order and we will arrange premium gift wrapping." },
    { cat: "Gifting", q: "Can I include a personalised message with a gift?", a: "Yes — for WhatsApp orders, send us the message you would like included and we will add a handwritten or printed card with your gift." },
  ];

  const categories = ["All", "About Nevisan", "Buying Guide", "Shipping & Orders", "Lemongrass Green", "Blue Flower Green", "Rum Green", "Spearmint Green", "Tulsi Green", "Chamomile Green", "Whiskey Green", "GABA Oolong", "Organic Green", "Health & Wellness", "Brewing & Storage", "Gifting"];
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { style: { textAlign: "center", marginBottom: e ? 36 : 48 } },
        React.createElement(
          "div",
        ...
        React.createElement("h2", { style: { fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 400, fontSize: "clamp(24px, 3.5vw, 42px)", color: T.text, marginBottom: 12 } }, "Frequently Asked Questions"),
        React.createElement("p", { style: { fontFamily: "'Inter'", fontSize: 14, color: T.textMuted, margin: 0 } }, filtered.length + " questions across " + categories.length + " categories"),
      ),
      React.createElement(
        "div",
        { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 36, justifyContent: "center" } },
        categories.map(cat =>
          React.createElement(
            "button",
            {
              key: cat,
              onClick: () => { setActiveCategory(cat); a(null); },
              style: {
                padding: "7px 16px",
                borderRadius: 9999,
                border: activeCategory === cat ? "1.5px solid " + T.teal : "1.5px solid rgba(35,65,45,0.18)",
                background: activeCategory === cat ? T.teal : "#fff",
                color: activeCategory === cat ? "#fff" : T.teal,
                fontFamily: "'Inter'",
                fontSize: 12,
                fontWeight: 600,
                cursor: "pointer",
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              {
                ...
                style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: e ? "14px 16px" : "18px 24px", background: "none", border: "none", cursor: "pointer", textAlign: "left", gap: 16 },
              },
              React.createElement(
                "div",
                { style: { flex: 1 } },
                activeCategory === "All" && React.createElement("span", { style: { fontFamily: "'Inter'", fontSize: 10, fontWeight: 700, letterSpacing: "0.1em", color: T.gold, textTransform: "uppercase", display: "block", marginBottom: 4 } }, n.cat),
                React.createElement("span", { style: { fontFamily: "'Inter'", fontSize: e ? 13 : 15, fontWeight: 600, color: T.text, lineHeight: 1.4 } }, n.q),
              ),
            ...
            t === o &&
              React.createElement(
                "div",
                { style: { padding: e ? "0 16px 16px" : "0 24px 20px" } },
                React.createElement("div", { style: { height: 1, background: "#f0ede8", marginBottom: e ? 12 : 16 } }),
      ...
      React.createElement(
        ...
        React.createElement("p", { style: { fontFamily: "'Inter'", fontSize: 14, color: T.textMuted, marginBottom: 16 } }, "Still have a question?"),
        React.createElement(
          "a",
          {
            ...
            target: "_blank",
            rel: "noopener noreferrer",
            style: { display: "inline-flex", alignItems: "center", gap: 8, background: "#25D366", color: "#fff", borderRadius: 9999, padding: "12px 28px", fontFamily: "'Inter'", fontSize: 14, fontWeight: 600, textDecoration: "none" },
          },
          React.createElement(
            "svg",
